...
const FontControls = () => {
  ...
  return (
    <div className="block">
      <label
        htmlFor=""
        className="mr-2 text-xl text-neutral-900 dark:text-neutral-300"
      >
        {" "}
        Font
        <br />
        ...
        >
          ...
          <option
            value="font-serif"
            className="font-serif dark:text-neutral-900"
          >
            Serif
          </option>
          ...
          <option
            value="font-cursive"
            className="font-cursive dark:text-neutral-900"
          >
            Cursive
          </option>
          ...
          <option
            ...
            className="font-extralight dark:text-neutral-900"
          >
            Extralight
          </option>
          <option
            value="font-light"
            className="font-light dark:text-neutral-900"
          >
            Light
          </option>
          <option
            value="font-normal"
            className="font-normal dark:text-neutral-900"
          >
            Normal
          </option>
          <option
            value="font-medium"
            className="font-medium dark:text-neutral-900"
          >
            Medium
          </option>
          <option
            value="font-semibold"
            className="font-semibold dark:text-neutral-900"
          >
            Semibold
          </option>
          ...
          <option
            ...
            className="font-extrabold dark:text-neutral-900"
          >
            Extrabold
          </option>
          <option
            value="font-black"
            className="font-black dark:text-neutral-900"
          >
            Black
          </option>
        </select>
