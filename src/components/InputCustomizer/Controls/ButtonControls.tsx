...
const ButtonControls = () => {
  ...
  const handleLogs = () => {
    ...
    console.log(`Borde ${borderEnabled ? 'Sí' : 'No'}. ${borderEnabled && ` Color ${borderColor}, intensidad ${borderIntensity}`}`);
    console.log(`Hover ${hoverEnabled? 'Sí' : 'No'}`);
    if(hoverEnabled){
        console.log(`Color de texto del hover: ${hoverColor}, con intensidad de: ${hoverIntensity}. BG color: ${hoverBgColor}, con intensidad de: ${hoverBgIntensity}`);
  ...
  return (
    <div className="flex justify-around">
      ...
      {borderEnabled && (
          ...
          <label htmlFor="" className="text-xl dark:text-neutral-300">
            ...
            <select
              name=""
              id=""
              className={`rounded-full  font-semibold border-2 border-black dark:text-neutral-900 text-center`} onChange={handelBorderIntensity}
            >
      ...
      <label htmlFor="" className="text-xl dark:text-neutral-300">
        <input type="checkbox" className="size-4 mr-3"  checked={hoverEnabled} onChange={handleHoverCheckboxChange}/>
        Hover
      </label>
      {
          hoverEnabled && (
      ...
      <br />
      <label htmlFor="" className="text-xl dark:text-neutral-300">Hover Color & Intensity
      <br />
      ...
      <label htmlFor="" className="text-xl dark:text-neutral-300">Hover Background Color & Intensity
      <br />
      <div className="flex justify-between">
      <select
          className={`rounded-full ${getColorClass(
      ...
      <label htmlFor="" className="text-xl dark:text-neutral-300">
        ...
        <label htmlFor="">
          ...
          <select
            name=""
            id=""
            className={`rounded-full  font-semibold border-2 border-black dark:text-neutral-900 text-center mt-1`} onChange={handleBgIntensity}
          >
            <option value="500" className="dark:text-neutral-300">
                Default (500)
              </option>
